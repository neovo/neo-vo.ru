...
$sFormTitle = Core::_('Shop_Price.show_prices_title');
...
$oAdmin_Form_Entity_Menus->add(
	Admin_Form_Entity::factory('Menu')
		->name(Core::_('Shop_Price.show_price_menu_title'))
		->icon('fa fa-usd')
		->add(
			Admin_Form_Entity::factory('Menu')
				->name(Core::_('Shop_Price.show_price_menu_title_add'))
				->icon('fa fa-plus')
...
{
	$Shop_Price_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Shop_Price_Controller_Edit', $oAdmin_Form_Action
	);

	$Shop_Price_Controller_Edit
		->addEntity($oAdmin_Form_Entity_Breadcrumbs);

	// Добавляем типовой контроллер редактирования контроллеру формы
	$oAdmin_Form_Controller->addAction($Shop_Price_Controller_Edit);
}
...
$oAdmin_Form_Dataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Shop_Price')
);
