...
// Код формы
$iAdmin_Form_Id = 64;
$sAdminFormAction = '/admin/shop/company/index.php';
...
$oAdmin_Form_Controller
	...
	->title(Core::_('Shop_Company.company_show_title2'))
	->pageTitle(Core::_('Shop_Company.company_show_title2'));
...
$oAdmin_Form_Entity_Menus->add(
	Admin_Form_Entity::factory('Menu')
		->name(Core::_('Shop_Company.company_show_title'))
		->icon('fa fa-building-o')
		->add(
			Admin_Form_Entity::factory('Menu')
				->name(Core::_('Shop_Company.company_show_title_add'))
				->icon('fa fa-plus')
...
$oAdmin_Form_Entity_Breadcrumbs->add(
	Admin_Form_Entity::factory('Breadcrumb')
		->name(Core::_('Shop_Company.company_show_title2'))
		->href
		(
...
if ($oAdmin_Form_Action && $oAdmin_Form_Controller->getAction() == 'edit')
{
	$ShopCompany_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Shop_Company_Controller_Edit', $oAdmin_Form_Action
	);
...
(
	Core_Entity::factory('Shop_Company')
);
