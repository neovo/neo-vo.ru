...
<body class="font_sans_serif base_font">
		...
		<p><?php echo Core::_("Shop_Order.acceptance_report_customer"). ': ' . $oShop_Order->company?><br/><?php echo Core::_("Shop_Order.acceptance_report_address").implode(', ', array($oShop_Order->postcode, $oShop_Order->Shop_Country_Location_City->name, $oShop_Order->address, Core::_("Shop_Order.acceptance_report_phone").' '.$oShop_Order->phone))?></p>
