...
// Код формы
$iAdmin_Form_Id = 60;
$sAdminFormAction = '/admin/shop/country/location/city/index.php';
...
$oAdmin_Form_Entity_Menus->add(
	Admin_Form_Entity::factory('Menu')
		->name(Core::_('Shop_Country_Location_City.cities_main_form_menu'))
		->icon('fa fa-flag-o')
		->add(
			Admin_Form_Entity::factory('Menu')
				->name(Core::_('Shop_Country_Location_City.cities_main_form_menu_add'))
				->icon('fa fa-plus')
				->img('/admin/images/city_add.gif')
				->href(
...
{
	$ShopCountryLocationCity_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Shop_Country_Location_City_Controller_Edit', $oAdmin_Form_Action
	);
	...
	$oAdmin_Form_Controller->addAction($ShopCountryLocationCity_Controller_Edit);
}
