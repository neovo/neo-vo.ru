...
else
{
	...
	$oAdmin_Form_Entity_Form->add($oMainTab
		...
		->add(Admin_Form_Entity::factory('Div')->class('row')->add(Admin_Form_Entity::factory('Checkbox')
			...
			->value(TRUE)
			->divAttr(array('id' => 'import_price_name_field_f','class' => 'form-group col-lg-12 col-md-12 col-sm-12'))))
		->add(Admin_Form_Entity::factory('Div')->class('row')
			->add(Admin_Form_Entity::factory('Radiogroup')
				...
				->divAttr(array('class' => 'no-padding-right form-group col-lg-9 col-md-9 col-sm-9 col-xs-10', 'id' => 'import_price_separator'))
			...
			->add(Admin_Form_Entity::factory('Input')
				...
				->caption('&nbsp;')
				->divAttr(array('id' => 'import_price_separator_text','class' => 'no-padding-left form-group col-lg-1 col-md-1 col-sm-1 col-xs-1'))))
		->add(Admin_Form_Entity::factory('Div')->class('row')->add(Admin_Form_Entity::factory('Radiogroup')
			->radio(array(
			...
			->divAttr(array('class' => 'no-padding-right form-group col-lg-9 col-md-9 col-sm-9 col-xs-10', 'id' => 'import_price_stop')))
			->add(Admin_Form_Entity::factory('Code')
			->html("<script>$(function() {
			...
			->caption('&nbsp;')
			->divAttr(array('id' => 'import_price_stop_text','class' => 'no-padding-left form-group col-lg-1 col-md-1 col-sm-1 col-xs-1'))))
		...
		->add(Admin_Form_Entity::factory('Div')->class('row')->add(
			Admin_Form_Entity::factory('Radiogroup')
				...
				->divAttr(array('id' => 'import_price_action_items','class' => 'form-group col-lg-12 col-md-12 col-sm-12'))
				->value(1)
		...
		->add(Admin_Form_Entity::factory('Div')->class('row')->add(Admin_Form_Entity::factory('Checkbox')
			...
			->divAttr(array('id' => 'import_price_action_delete_image','class' => 'form-group col-lg-12 col-md-12 col-sm-12'))))
		->add(Admin_Form_Entity::factory('Div')->class('row')->add(Admin_Form_Entity::factory('Checkbox')
			->name("search_event_indexation")
			->caption(Core::_('Shop_Item.search_event_indexation_import'))
			->divAttr(array('id' => 'search_event_indexation','class' => 'form-group col-lg-12 col-md-12 col-sm-12'))))
		->add(Admin_Form_Entity::factory('Div')->class('row')->add(Admin_Form_Entity::factory('Input')
			->name("import_price_max_time")
			->caption(Core::_('Shop_Item.import_price_list_max_time'))
			->value(20)
			->divAttr(array('id' => 'import_price_max_time', 'class' => 'form-group col-lg-6 col-md-6 col-sm-6')))
			->add(Admin_Form_Entity::factory('Input')
			->name("import_price_max_count")
			->caption(Core::_('Shop_Item.import_price_list_max_count'))
			->value(100)
			->divAttr(array('id' => 'import_price_max_count', 'class' => 'form-group col-lg-6 col-md-6 col-sm-6')))))
	;
