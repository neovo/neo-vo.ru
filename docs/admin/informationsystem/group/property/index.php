...
$oAdmin_Form_Dataset->addCondition(
	...
	array('where' =>
		array('informationsystem_group_property_dirs.informationsystem_id', '=', $informationsystem_id)
	)
)
...
$oAdmin_Form_Dataset->addCondition(
	...
	array('where' =>
		array('informationsystem_group_properties.informationsystem_id', '=', $informationsystem_id)
	)
);
