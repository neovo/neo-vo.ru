...
// Код формы
$iAdmin_Form_Id = 124;
$sAdminFormAction = '/admin/document/status/index.php';
...
$oAdmin_Form_Controller
	...
	->title(Core::_('Document_Status.title'))
	->pageTitle(Core::_('Document_Status.title'));
...
$oAdmin_Form_Entity_Breadcrumbs->add(
	...
	Admin_Form_Entity::factory('Breadcrumb')
		->name(Core::_('Document_Status.title'))
		->href(
...
if ($oAdmin_Form_Action && $oAdmin_Form_Controller->getAction() == 'edit')
{
	$oDocument_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Document_Status_Controller_Edit', $oAdmin_Form_Action
	);
...
$oAdmin_Form_Dataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Document_Status')
);
