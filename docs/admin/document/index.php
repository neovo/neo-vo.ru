...
$oAdmin_Form_Entity_Menus->add(
	Admin_Form_Entity::factory('Menu')
		...
		->add(
			...
			Admin_Form_Entity::factory('Menu')
				->name(Core::_('Document.deleteAllDirOldVersion'))
				->icon('fa fa-trash-o')
				->img('/admin/images/page_delete.gif')
				->href(
					$oAdmin_Form_Controller->getAdminActionLoadHref($oAdmin_Form_Controller->getPath(), 'deleteOldDocumentVersions', NULL, 1, 0)
				)
				->onclick(
					$oAdmin_Form_Controller->getAdminActionLoadAjax($oAdmin_Form_Controller->getPath(), 'deleteOldDocumentVersions', NULL, 1, 0)
				)
		)
)
->add(
