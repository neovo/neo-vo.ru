 ...
 */
class Core_Command_Controller_Key_Not_Found extends Core_Command_Controller
{
	/**
	 * Default controller action
	 * @return Core_Response
	 * @hostcms-event Core_Command_Controller_Key_Not_Found.onBeforeShowAction
	 * @hostcms-event Core_Command_Controller_Key_Not_Found.onAfterShowAction
	 */
	public function showAction()
	{
		...
		$title = Core::_('Core.key_not_found');
