...
function InitiateWidgets() {
    $('.page-content').on("click", '.widget-buttons *[data-toggle="maximize"]', function (event) {
    ...
    $('.page-content').on("click", '.widget-buttons *[data-toggle="collapse"]', function (event) {
        event.preventDefault();
        var widget = $(this).parents(".widget").eq(0);
    ...
    $('.page-content').on("click", '.widget-buttons *[data-toggle="dispose"]', function (event) {
        event.preventDefault();
