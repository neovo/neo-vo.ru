...
class Informationsystem_Item_Property_List_Model extends Informationsystem_Model
{
	 ...
	 * @var string
	 */
	protected $_modelName = 'informationsystem_item_property_list';
	...
	protected $_hasMany = array(
		'property' => array(
			'through' => 'informationsystem_item_property',
			'foreign_key' => 'informationsystem_id',
			'dependent_key' => 'property_id'
		),
		'property_dir' => array(
			'through' => 'informationsystem_item_property_dir',
			'foreign_key' => 'informationsystem_id',
	...
	{
		return 'information_items_property_' . $oFileValue->id . '.' . Core_File::getExtension($originalFileName);
	}
	...
	{
		return 'small_information_items_property_' . $oFileValue->id . '.' . Core_File::getExtension($originalFileName);
	}
