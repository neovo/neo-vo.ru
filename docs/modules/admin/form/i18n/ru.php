...
return array(
	...
	'show_forms_title' => 'Формы центра администрирования',
	'confirm_dialog' => 'Вы уверены, что хотите %s?',
	...
	'markDeleted_success' => 'Форма успешно удалена!',
	'markDeleted_error' => 'Ошибка! Форма не удалена!',
	// -----------------------------------------

	'edit_success' => 'Информация о форме добавлена!',
	...
	'window_small_image' => 'Малое изображение',

	'large_image_max_width' => '<acronym title="Максимальная ширина изображения, получающегося при его уменьшении">Максимальная ширина изображения</acronym>',
	'large_image_max_height' => '<acronym title="Максимальная высота изображения, получающегося при его уменьшении">Максимальная высота изображения</acronym>',
